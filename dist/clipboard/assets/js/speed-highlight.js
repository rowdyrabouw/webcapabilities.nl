...
var Qt,
  W = a(() => {
    f();
    Qt = [{ type: "kwd", match: /^(FROM|RUN|CMD|LABEL|MAINTAINER|EXPOSE|ENV|ADD|COPY|ENTRYPOINT|VOLUME|USER|WORKDIR|ARG|ONBUILD|STOPSIGNAL|HEALTHCHECK|SHELL)\b/gim }, ...T];
  });
var j = {};
p(j, { default: () => Jt });
var Jt,
  K = a(() => {
    N();
    Jt = [{ match: /^#.*/gm, sub: "todo" }, { expand: "str" }, ...I, { type: "func", match: /^(\$ )?git(\s.*)?$/gm }, { type: "kwd", match: /^commit \w+$/gm }];
  });
var V = {};
p(V, { default: () => te });
var te,
...
var J = {};
p(J, { default: () => A, name: () => E, properties: () => l, xmlElement: () => o });
var Q,
  ee,
  E,
  l,
  ...
  A,
  R = a(() => {
    (Q = ":A-Z_a-z\xC0-\xD6\xD8-\xF6\xF8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD"),
      (ee = Q + "\\-\\.0-9\xB7\u0300-\u036F\u203F-\u2040"),
      (E = `[${Q}][${ee}]*`),
      (l = `\\s*(\\s+${E}\\s*(=\\s*([^"']\\S*|("|')(\\\\[^]|(?!\\4)[^])*\\4?)?)?\\s*)*`),
      (o = {
        match: RegExp(`<[/!?]?${E}${l}[/!?]?>`, "g"),
        sub: [
          { type: "var", match: RegExp(`^<[/!?]?${E}`, "g"), sub: [{ type: "oper", match: /^<[\/!?]?/g }] },
...
var ae,
  et = a(() => {
    ...
    ae = [
      ...
      { match: RegExp(`<style${l}>((?!</style>)[^])*</style\\s*>`, "g"), sub: [{ match: RegExp(`^<style${l}>`, "g"), sub: o.sub }, { match: RegExp(`${o.match}|[^]*(?=</style\\s*>$)`, "g"), sub: "css" }, o] },
      { match: RegExp(`<script${l}>((?!<\/script>)[^])*<\/script\\s*>`, "g"), sub: [{ match: RegExp(`^<script${l}>`, "g"), sub: o.sub }, { match: RegExp(`${o.match}|[^]*(?=<\/script\\s*>$)`, "g"), sub: "js" }, o] },
      ...A,
    ];
  });
var pe,
  ...
  d = a(() => {
    (pe = [
      ...
      (u = (t) =>
        pe
          .map(([e, ...s]) => [e, s.reduce((c, [m, n]) => c + [...t.matchAll(m)].length * n, 0)])
          .filter(([e, s]) => s > 20)
    ...
    (me = [
      {
        match: new (class {
          exec(t) {
            ...
            for (; e < t.length; ++e) if (t[e - 1] != "\\" && t[e] == "$" && t[e + 1] == "{") return (s = e++), c(e), (this.lastIndex = e + 1), { index: s, 0: t.slice(s, e + 1) };
            return null;
          }
        })(),
        sub: [
...
var Ee,
  ...
  ht = a(() => {
    S();
    (Ee = [{ type: "kwd", match: /@\w+/g }, { type: "class", match: /{[\w\s|<>,.@\[\]]+}/g }, { type: "var", match: /\[[\w\s="']+\]/g }, ...x]), (le = "cmnt");
  });
var it = {};
p(it, { default: () => ue });
var ue,
  gt = a(() => {
    ue = [{ type: "var", match: /("|')?[a-zA-Z]\w*\1(?=\s*:)/g }, { expand: "str" }, { expand: "num" }, { type: "num", match: /\bnull\b/g }, { type: "bool", match: /\b(true|false)\b/g }];
  });
var dt = {};
p(dt, { default: () => C });
var C,
    ...
    he = [
      {
        ...
        sub: [
          ...
          { match: /(?!leanpub-start-insert)((?!leanpub-end-insert)[^])*/g, sub: u },
        ],
      },
      {
        type: "deleted",
        ...
        sub: [
          ...
          { match: /(?!leanpub-start-delete)((?!leanpub-end-delete)[^])*/g, sub: u },
        ],
      },
      ...C,
    ];
...
var Oe,
  Ht = a(() => {
    L();
    Oe = [{ type: "type", match: /:\s*(any|void|number|boolean|string|object|never|enum)\b/g }, { type: "kwd", match: /\b(type|namespace|typedef|interface|public|private|protected|implements|declare|abstract|readonly)\b/g }, ...O];
  });
var kt = {};
p(kt, { default: () => Le });
var Le,
...
var U = { num: { type: "num", match: /(\.e?|\b)\d(e-|[\d.oxa-fA-F_])*(\.|\b)/g }, str: { type: "str", match: /(["'])(\\[^]|(?!\1)[^\r\n\\])*\1?/g }, strDouble: { type: "str", match: /"((?!")[^\r\n\\]|\\[^])*"?/g } };
var Se = w({
  ...
  "./languages/css.js": () => Promise.resolve().then(() => (_(), k)),
  ...
  "./languages/js_template_literals.js": () => Promise.resolve().then(() => (Et(), ot)),
...
async function Zt(t, e, s) {
  try {
    let c,
      ...
      r = [],
      h = 0,
      y = typeof e == "string" ? await (b[e] ?? (b[e] = Se(`./languages/${e}.js`))) : e,
      g = [...(typeof e == "string" ? y.default : e.sub)];
    for (; h < t.length; ) {
      for (n.index = null, c = g.length; c-- > 0; ) {
        if (((m = g[c].expand ? U[g[c].expand] : g[c]), r[c] === void 0 || r[c].match.index < h)) {
        ...
        r[c].match[0] && (r[c].match.index <= n.index || n.index === null) && (n = { part: m, index: r[c].match.index, match: r[c].match[0], end: r[c].lastIndex });
      }
      if (n.index === null) break;
      s(t.slice(h, n.index), y.type), (h = n.end), n.part.sub ? await Zt(n.match, typeof n.part.sub == "string" ? n.part.sub : typeof n.part.sub == "function" ? n.part.sub(n.match) : n.part, s) : s(n.match, n.part.type);
    }
...
`).length < 2
    ...
    (t.dataset.lang = e),
    (t.className = `${[...t.classList].filter((n) => !n.startsWith("shj-")).join(" ")} shj-lang-${e} shj-${s}`),
    (t.innerHTML = await we(m, e, s == "multiline", c));
}
var Ke = async (t) => Promise.all(Array.from(document.querySelectorAll('[class*="shj-lang-"]')).map((e) => Ue(e, void 0, void 0, t))),
  Ve = (t, e) => {
    b[t] = e;
  };
